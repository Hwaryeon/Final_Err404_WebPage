	...
	<div class="container">
		...
		<div class="main col-md-6 col-xs-12">
			...
			<div class="widget fullwidth post-single" style="margin-bottom:1px;">
				<h4 class="widget-title" style="font-size:20px;">공동리더 <span style="float:right; border:1px solid #fdb00d!important; padding:7px;">
				<a style="font-size:12px; color:#fdb00d!important;">공동리더 추가</a></span></h4>
			</div>
			 ...
			 <div class="author-bar widget" style="margin-bottom:1px;">
              <div class="author-content">
                ...
                <h4><a href="" title="Posts by admin" rel="author">Robert Johnson</a></h4>
                <div class="clear"></div>
              </div>
            </div>
