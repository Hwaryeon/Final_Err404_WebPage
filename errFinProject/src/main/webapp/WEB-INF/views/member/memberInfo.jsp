    ...
    <div class="container">
       ...
       <div class="main col-md-9 col-md-push-3 col-xs-12">
            ...
            <div class="widget fullwidth post-single">
                <h4 class="widget-title">내 밴드 보기</h4>
                <div class="widget-content">
                    <ul>
                        <li>
                            <a href="#"><img src="http://placehold.it/70x70" alt=""></a>
                            <h4 class="list-title"><a href="#">밴드1</a></h4>
                            <p>여기에 한줄
                            한줄더?</p><br>
                        </li>
                       <li>
                            <a href="#"><img src="http://placehold.it/70x70" alt=""></a>
                            <h4 class="list-title"><a href="#">밴드2</a></h4>
                            <p>여기에 한줄
                            한줄더?</p><br>
                        </li><li>
                            <a href="#"><img src="http://placehold.it/70x70" alt=""></a>
                            <h4 class="list-title"><a href="#">밴드3</a></h4>
                            <p>여기에 한줄
                            한줄더?</p><br>
                        </li><li>
                            <a href="#"><img src="http://placehold.it/70x70" alt=""></a>
                            <h4 class="list-title"><a href="#">밴드4</a></h4>
                            <p>여기에 한줄
                            한줄더?</p><br>
                        </li><li>
                            <a href="#"><img src="http://placehold.it/70x70" alt=""></a>
                            <h4 class="list-title"><a href="#">밴드5</a></h4>
                            <p>여기에 한줄
                            한줄더?</p><br>
                        </li>
                    </ul>
        ...
        <div class="left-sidebar col-md-pull-9 col-md-3" role="complementary">
             ...
             <div class="recent-widget widget padding-0" id="tabbed-widget">
               <h4 class="widget-title">마이페이지</h4><br><hr>
                <div class="widget-content">
                    <ul>
                        <li>
                            <h4 class="list-title"><a href="#">회원 정보 수정</a></h4>
                            <hr>
                        </li>
                        <li>

                            <h4 class="list-title"><a href="#">내가 쓴 글</a></h4>
                    <hr>
                        </li>
                        <li>

                            <h4 class="list-title"><a href="#">가입 신청 중인 밴드</a></h4>
<hr>
                        </li>
