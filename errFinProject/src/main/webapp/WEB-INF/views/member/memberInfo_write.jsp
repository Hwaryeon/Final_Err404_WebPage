							...
							<table style="display: table-cell;">
								<tr style="border-bottom: 1px solid lightgray;">
									<td height="50px" width="150px"
										style="vertical-align: middle; text-align: center;">밴드이름</td>
									<td width="600px"
										style="vertical-align: middle; text-align: center;">작성 글</td>
									<td width="150px"
										style="vertical-align: middle; text-align: center;">작성일자</td>
								</tr>
								<c:forEach var="board" items="${ list }">
									<c:set var="content" value="${ board.bContent }" />
									<tr>
										<td height="50px"
											style="vertical-align: middle; text-align: center;">${ board.bName }</td>
							...
							<div align="center">
								...
								<c:if test="${ pi.currentPage > 1 }">
									<c:url var='bListBack' value="showMemberInfo_write.mb">
										<c:param name="requestCurrentPage"
				...
				<div class="widget-content">
					...
					<c:param name = "mid" value = "${ sessionScope.loginUser.mid }"/>
						...
						<li>
							...
							<h4 class="list-title">
								<a
									href='<c:url value = "showMemberInfo_write.mb">
					<c:param name = "mid" value = "${ sessionScope.loginUser.mid }"/>
					<c:param name="requestCurrentPage" value = "1"/>
						...
						<li>
							...
							<h4 class="list-title">
								<a
									href='<c:url value = "showMemberInfo_bandlist.mb">
									<c:param name = "mid" value = "${ sessionScope.loginUser.mid }"/>
									</c:url>'>내
									밴드 모아보기</a>
							</h4>
