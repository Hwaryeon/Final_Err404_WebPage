			...
			<div class="main col-md-6 col-xs-12">
				<div class="admin-container">
					...
					<table class="admin-table">
						...
						<c:forEach var="reportBand" items="${ reportBand }">
							<tr>
								...
								<td>${ reportBand.times }</td>
								<td>
									<c:if test="${ reportBand.times >= 5 }">
										<button onclick="location.href='showReportBand.ad?bid=${reportBand.bid}'">
											상세보기
										</button>
									</c:if>
								</td>
					...
					<div class="paging-area">
						...
						<c:if test="${ pi.currentPage > 1 }">
							<c:url var='mListBack' value="ReportBandSelect.ad">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							...
							<c:if test="${ p ne pi.currentPage }">
								<c:url var="mListCheck" value="ReportBandSelect.ad">
						...
						<c:if test="${ pi.currentPage < pi.maxPage }">
							<c:url var="mListNext" value="ReportBandSelect.ad">
								<c:param name="requestCurrentPage" value="${ pi.currentPage + 1 }"/>
							</c:url>
