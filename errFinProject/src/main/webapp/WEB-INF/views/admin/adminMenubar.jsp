...
<link href="${ contextPath }/resources/css/light-pink-blue.css"
	rel="stylesheet">
		...
		<div class="container">
			<div class="col-md-6 col-xs-12" style="min-width: 600px;">
				<div class="logo" style="width: 120px; min-width: 120px; float: left;">
					<h1>
						<a href="index.html" title="Weekend Magazine">ERR404</a>
					</h1>
				</div>
				<!-- <div id="search-3" class="widget fullwidth widget_search"
					...
					<div class="search" style="color: black; margin: -12px;">
						...
						<input type="search" id='searchBox' value="" name="searchBox"
							placeholder="검색 &hellip;" title="검색" autocomplete=off>
			...
			<div class="col-md-6 col-xs-12" style="width: 525px;">
				<%-- <div class="post widget" style="float: unset; padding-left: 138px;">
					<div class="post-social" id="postsocial"
						...
						<ul class="share-social">
							<li><a target="_blank" href="" style="border: 0px;"><img
									src="${ contextPath }/resources/images/al.png " alt=""
									width=25px; height=25px;></a></li>
							<li><a onclick="chatting();" style="border: 0px;"><img
									src="${ contextPath }/resources/images/message.png " alt=""
									width=25px; height=25px;></a></li>
							<li><a
								href="<c:url value = "showMemberInfo_update.me">
									<c:param name = "mid" value = "${ sessionScope.loginUser.mid }"/>
								  </c:url>"
								style="border: 0px;"><img
									src="${ contextPath }/resources/images/profile.png " alt=""
									width=25px; height=25px;></a></li>
						</ul>
					</div>
				</div> --%>
