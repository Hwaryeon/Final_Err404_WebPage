		...
		<div class="main col-md-6 col-xs-12">
			...
			<div class="widget clearfix">
				<div id="respond" class="comment-respond">
					<h3 id="reply-title" class="comment-reply-title">
						멤버<small><a rel="nofollow" id="cancel-comment-reply-link"
							href="" style="display: none;">Cancel reply</a></small>
						<div style="float: right">
									<a href="#"><img alt="" src="${ contextPath }/resources/images/addMember.png"
								class="avatar avatar-75 photo avatar-default" ></i></a>
								</div>
					</h3>

					<div id="search-3" class="widget fullwidth widget_search">
						<form class="search" role="search" method="get" action="#">
							<input type="search" placeholder="멤버 검색 &hellip;" value=""
			...
			<div class="recent-widget widget padding-0" id="tabbed-widget">
				<ul class="nav nav-justified nav-tabs">
					<li class="active"><a href="#popular" data-toggle="tab">member</a></li>
							...
							<li>
								...
								<div class="thumb">
									<a href="#"> <img width="60" height="60"
										src="http://placehold.it/56x56" alt="">
									</a>
								</div>
								<h3 >&nbsp</h3>
								<div style="float: right">
									<a href="#"><img alt="" src="${ contextPath }/resources/images/chat.png"
								class="avatar avatar-75 photo avatar-default" ></i></a>
								</div>
								<h3 >멤버 이름</h3>
